#NoTrayIcon
#RequireAdmin
#include <include\THHH_Offsets_3.3.5.au3> ; THHH_Offsets_3.3.2.au3 / THHH_Offsets_3.3.3.au3
#include <include\THHH_Language_func.au3>
#include <include\THHH_Raccourcis.au3>
#include <include\THHH_GetKeyPressed.au3>
#include <include\THHH_TPList_func.au3>
#include <include\THHH_Reglages.au3>
#include <include\MemWriteGCD.au3>
...
$WowProcessList = ProcessList("RPWoW.exe")
$Wowpid1 = ProcessExists("RPWoW.exe")
...
$TrackValueH = 0
#Region ### GUI ###
$THHHGUI = GUICreate("The RPwow Hack", 332, 655, -1, -1)
...
If $Wowpid1 = "" Then
MsgBox(0,"", "Wow process not exist")
Exit
Else
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; PRIVE ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
$tab0 = GUICtrlCreateTabItem("Func(Private)")
...
$PriveTeleportationGRP = GUICtrlCreateLabel("Teleportation", 167, 80, 75, 17)
$PrivePVPGRP = GUICtrlCreateLabel("PVP", 172, 310, 30, 17)
$PriveXYZGRP = GUICtrlCreateLabel("XYZ", 172, 235, 30, 17)
$PriveTrackingGRP = GUICtrlCreateLabel("Tracking", 30, 485, 50, 17)
Else
$PriveTeleportationGRP = GUICtrlCreateGroup("Teleportation", 157, 80, 170, 155)
...
$PriveGoTP = GUICtrlCreateButton("Teleport", 195, 200, 55, 25, $WS_GROUP)
$PriveGoCorps = GUICtrlCreateButton("Go to corpse", 251, 200, 68, 25, $WS_GROUP)
$ListOuvrir = GUICtrlCreateButton("List", 163, 200, 30, 25, $WS_GROUP)
$PriveXYZON = GUICtrlCreateCheckbox("Checkbox", 266, 260, 15, 15)
$LBLActiverXYZ = GUICtrlCreateLabel("Activate XYZ", 172, 260, 68, 17)
$PriveXYZSpeedInput = GUICtrlCreateInput(0.5, 241, 280, 35, 20)
$LBLVitesseXYZ = GUICtrlCreateLabel("XYZ Speed", 172, 282, 58, 17)
$PriveTPcibleDos = GUICtrlCreateButton("TP Target(back)", 167, 325, 104, 25, $WS_GROUP)
$PriveTPcibleUndermap = GUICtrlCreateButton("TP Targ.(undermap)", 167, 350, 104, 25, $WS_GROUP)
...
$LBLPriveCollisionsM2 = GUICtrlCreateLabel("Disable M2 collisions",167,421,120,17)
$PriveCollisionsWMO = GUICtrlCreateCheckbox("Checkbox",297,440,17,17)
$LBLPriveCollisionsWMO = GUICtrlCreateLabel("Disable WMO collisions",167,441,130,17)
...
$LBLNoclip = GUICtrlCreateLabel("No Clip 1", 30, 191, 80, 17)
$PriveWaterWalkON = GUICtrlCreateCheckbox("Checkbox", 132, 210, 15, 15)
$LBLWalkonwater = GUICtrlCreateLabel("walk-on-water", 30, 211, 80, 17)
$PriveUnderwaterWalkON = GUICtrlCreateCheckbox("Checkbox", 132, 230, 15, 15)
$LBLUnderwaterWalk = GUICtrlCreateLabel("walk-under-water", 30, 231, 90, 17)
$PriveMountON = GUICtrlCreateCheckbox("Checkbox", 132, 250, 15, 15)
$LBLMount = GUICtrlCreateLabel("Use mount in interior", 30, 251, 97, 17)
...
$LBLInfiniteJump = GUICtrlCreateLabel("Multi-jump", 30, 331, 70, 17)
$PriveSuperSautON = GUICtrlCreateCheckbox("Checkbox", 132, 350, 15, 15)
$LBLSupersaut = GUICtrlCreateLabel("Super-jump", 30, 351, 66, 17)
$PriveSuperSautInput = GUICtrlCreateInput(22, 30, 371, 115, 20)
$PriveFactionMENU = GUICtrlCreateCombo("Faction",30, 395,115, 25)
GUICtrlSetData(-1, "Creature|Alliance|Horde")
$PriveDebloPerso = GUICtrlCreateButton("Unstuck", 30, 420, 116, 25, $WS_GROUP)
$StopchuteON = GUICtrlCreateButton("Stop falling", 30, 445, 116, 25, $WS_GROUP)
$PriveTrackHerbes = GUICtrlCreateCheckbox("Herbes", 30, 500, 69, 15)
$PriveTrackFilons = GUICtrlCreateCheckbox("Minerals", 30, 520, 69, 15)
$PriveTrackCoffres = GUICtrlCreateCheckbox("Treasures", 30, 540, 69, 15)
$PriveTrackPoissons = GUICtrlCreateCheckbox("Fish", 30, 560, 69, 15)
$PriveTrackAllRes = GUICtrlCreateCheckbox("Everything", 30, 580, 68, 15)
...
$PriveTrackMortsVivants = GUICtrlCreateCheckbox("undeads", 210, 520, 85, 15)
...
$PriveTrackAllBet = GUICtrlCreateCheckbox("Everything", 170, 580, 68, 15)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; OFFICIEL ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
$tab1 = GUICtrlCreateTabItem("Func(Live)")
If IniRead($Setting,"Reglages","Interface","Erreur") = 1 Then
GUICTRLCREATEPIC(@ScriptDir&"\thhh_settings\skin\top.jpg", 0, 0, 332, 55, BitOR($WS_GROUP,$WS_CLIPSIBLINGS))
...
$TrackingGRP = GUICtrlCreateLabel("Tracking", 30, 290, 45, 17)
Else
$TeleportationGRP = GUICtrlCreateGroup("XYZ", 171, 90, 125, 125)
$TrackingGRP = GUICtrlCreateGroup("Tracking", 20, 290, 291, 115)
...
$LBLActiverXYZOf = GUICtrlCreateLabel("Activate XYZ", 181, 115, 68, 17)
$TPauto = GUICtrlCreateRadio("Automatic", 181, 160, 80, 17)
$TPmanu = GUICtrlCreateRadio("Manual", 181, 140, 80, 17)
...
$LBLWallclimbOf = GUICtrlCreateLabel("wallclimb", 35, 105, 75, 17)
$CollisionsM2 = GUICtrlCreateCheckbox("Checkbox",297,225,17,17)
$LBLCollisionsM2Of = GUICtrlCreateLabel("Disable M2 collisions",167,226,120,17)
$CollisionsWMO = GUICtrlCreateCheckbox("Checkbox",297,245,17,17)
$LBLCollisionsWMOOf = GUICtrlCreateLabel("Disable WMO collisions",167,246,130,17)
...
$LBLWaterWalkOf = GUICtrlCreateLabel("walk-on-water", 35, 145, 90, 17)
$UnderwaterWalkON = GUICtrlCreateCheckbox("Checkbox", 135, 165, 15, 15)
$LBLUnderwaterWalkOf = GUICtrlCreateLabel("walk-under-water", 35, 165, 90, 17)
$SuperSautON = GUICtrlCreateCheckbox("Checkbox", 135, 185, 15, 15)
$LBLSupersautOf = GUICtrlCreateLabel("Super-jump", 35, 185, 54, 17)
...
$TrackFilons = GUICtrlCreateCheckbox("Minerals", 30, 325, 69, 15)
$TrackCoffres = GUICtrlCreateCheckbox("Treasures", 30, 345, 69, 15)
$TrackPoissons = GUICtrlCreateCheckbox("Fish", 30, 365, 69, 15)
$TrackAllRes = GUICtrlCreateCheckbox("Everything", 30, 385, 68, 15)
$TrackBetes = GUICtrlCreateCheckbox("Beasts", 130, 305, 69, 15)
$TrackDragons = GUICtrlCreateCheckbox("Dragons", 130, 325, 69, 15)
$TrackDemons = GUICtrlCreateCheckbox("Demons", 130, 345, 69, 15)
$TrackElementaires = GUICtrlCreateCheckbox("Elementals", 130, 365, 71, 15)
$TrackGeants = GUICtrlCreateCheckbox("Giants", 210, 305, 69, 15)
$TrackMortsVivants = GUICtrlCreateCheckbox("undead", 210, 325, 85, 15)
$TrackHumanoides = GUICtrlCreateCheckbox("Humanoids", 210, 345, 77, 15)
$TrackBestioles = GUICtrlCreateCheckbox("Critters", 210, 365, 69, 15)
$TrackAllBet = GUICtrlCreateCheckbox("Everything", 170, 385, 68, 15)
$Raccourcis = GUICtrlCreateCheckbox("Checkbox", 300, 610, 15, 15)
$SCsettings = GUICtrlCreateButton("Shortcuts", 227, 608, 70, 19, $WS_GROUP)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; AFFICHAGE ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
$tab2 = GUICtrlCreateTabItem("Player")
If IniRead($Setting,"Reglages","Interface","Erreur") = 1 Then
GUICTRLCREATEPIC(@ScriptDir&"\thhh_settings\skin\top.jpg", 0, 0, 332, 55, BitOR($WS_GROUP,$WS_CLIPSIBLINGS))
GUICTRLCREATEPIC(@ScriptDir&"\thhh_settings\skin\mid_jou.jpg", 0, 76, 330, 479, $WS_GROUP)
$PlayerTailleGRP = GUICtrlCreateLabel("Scale", 40, 90, 45, 17)
$PlayerShowGRP = GUICtrlCreateLabel("Display", 215, 220, 80, 17)
$CameraGRP = GUICtrlCreateLabel("Camera", 40, 305, 45, 17)
$TempsGRP = GUICtrlCreateLabel("Time", 205, 300, 45, 17)
Else
$PlayerTailleGRP = GUICtrlCreateGroup("Scale", 30, 90, 265, 125)
$PlayerShowGRP = GUICtrlCreateGroup("Display", 205, 220, 90, 70)
$CameraGRP = GUICtrlCreateGroup("Camera", 30, 305, 160, 105)
$TempsGRP = GUICtrlCreateGroup("Time", 195, 300, 100, 110)
GUICtrlCreateGroup("", 30, 220, 170, 75)
GUICtrlCreateGroup("", 30, 415, 195, 80)
EndIf
$PlayerTailleP = GUICtrlCreateButton("Scale +", 40, 110, 60, 30, $WS_GROUP)
$PlayerTailleM = GUICtrlCreateButton("Scale -", 40, 152, 60, 30, $WS_GROUP)
$PlayerScaleInput = GUICtrlCreateInput($PlayerScaleVar, 160, 110, 80, 20)
$LBLTaille = GUICtrlCreateLabel("Scale", 110, 112, 50, 17)
$PlayerHauteurInput = GUICtrlCreateInput(Round($PlayerHauteurVar, 5), 160, 135, 80, 20)
$LBLHauteur = GUICtrlCreateLabel("Height", 110, 137, 40, 17)
$PlayerLargeurInput = GUICtrlCreateInput(Round($PlayerLargeurVar, 5), 160, 160, 80, 20)
$LBLLargeur = GUICtrlCreateLabel("width", 110, 162, 40, 17)
...
$LBLAlcool = GUICtrlCreateLabel("Alcohol", 40, 273, 54, 17)
...
$LBLMort = GUICtrlCreateLabel("Dead", 215, 240, 54, 17)
...
$LBLSpectateur = GUICtrlCreateLabel("Spectate mod", 40, 320, 100, 17)
...
$LBLNoclipCamera = GUICtrlCreateLabel("Follow target", 40, 340, 100, 17)
$CameraFollow =  GUICtrlCreateCheckbox("Checkbox", 170, 360, 15, 15)
$LBLFollowTar = GUICtrlCreateLabel("Follow target", 40, 360, 100, 17)
$PriveTeleportCamera = GUICtrlCreateButton("TP Camera(prive)", 50, 380, 120)
$HeureInput = GUICtrlCreateInput(_MemoryRead($TimeHeure,$WowProcess,"dword"), 240, 315, 25, 20)
$LBLHeure = GUICtrlCreateLabel("Hours", 200, 316, 40, 17)
...
$LBLVitesseTemps = GUICtrlCreateLabel("Speed", 200, 366, 40, 17)
$VitesseTempsInputOK = GUICtrlCreateButton("Ok", 270, 385, 20, 20, $WS_GROUP)
$MapSHOW = GUICtrlCreateButton("Reveal the map", 200, 510, 90, 28, $WS_GROUP)
...
$LBLEmote = GUICtrlCreateLabel("Emote on target", 85, 425, 110, 17)
...
$LangueGRP = GUICtrlCreateGroup("Language", 250, 10, 80, 40)
...
$LBLInterfaceOff = GUICtrlCreateLabel("Use default interface", 35, 50, 200, 50)
$ContinueOnExit = GUICtrlCreateCheckbox("Checkbox", 15, 80, 15, 15)
$LBLContinueOnExit = GUICtrlCreateLabel("Keep functions activated after closing program", 35, 80, 200, 50)
$SaveSettings = GUICtrlCreateCheckbox("Checkbox", 15, 120, 15, 15)
$LBLSaveSettings = GUICtrlCreateLabel("Activate following functions at launch:", 35, 122, 200, 50)
$LaunchPrivateGRP = GUICtrlCreateGroup("Func(Private)", 15, 155, 200, 120)
$LaunchSpeed = GUICtrlCreateCheckbox("Checkbox", 20, 170, 15, 15)
$LBLLaunchSpeed = GUICtrlCreateLabel("Speed", 40, 172, 60, 17)
$LaunchFly = GUICtrlCreateCheckbox("Checkbox", 20, 190, 15, 15)
$LBLLaunchFly = GUICtrlCreateLabel("FlyMod", 40, 192, 60, 17)
$LaunchWallclimbPrivate = GUICtrlCreateCheckbox("Checkbox", 20, 210, 15, 15)
$LBLLaunchWallClimbPrivate = GUICtrlCreateLabel("Wallclimb", 40, 212, 80, 17)
...
$LBLLaunchRaccourcisPrivate = GUICtrlCreateLabel("Shortcuts", 40, 252, 65, 17)
$LaunchSuperSautPrivate = GUICtrlCreateCheckbox("Checkbox", 130, 170, 15, 15)
$LBLLaunchSupersautPrivate = GUICtrlCreateLabel("Super-jump", 150, 172, 60, 17)
$LaunchTrackPrivate = GUICtrlCreateCheckbox("Checkbox", 130, 190, 15, 15)
$LBLLaunchTrackPrivate = GUICtrlCreateLabel("Tracking", 150, 192, 60, 17)
...
$LBLLaunchXYZPrivate = GUICtrlCreateLabel("Activate XYZ", 150, 232, 63, 17)
$LaunchOfficielGRP = GUICtrlCreateGroup("Func(Live)", 220, 155, 110, 120)
$LaunchSuperSautOfficiel = GUICtrlCreateCheckbox("Checkbox", 225, 170, 15, 15)
$LBLLaunchSupersautOfficiel = GUICtrlCreateLabel("Super-jump", 245, 172, 60, 17)
$LaunchWallclimbOfficiel = GUICtrlCreateCheckbox("Checkbox", 225, 190, 15, 15)
$LBLLaunchWallclimbOfficiel = GUICtrlCreateLabel("Wallclimb", 245, 192, 80, 17)
$LaunchTrackOfficiel = GUICtrlCreateCheckbox("Checkbox", 225, 210, 15, 15)
$LBLLaunchTrackOfficiel = GUICtrlCreateLabel("Tracking", 245, 212, 60, 17)
$LaunchXYZOfficiel = GUICtrlCreateCheckbox("Checkbox", 225, 230, 15, 15)
$LBLLaunchXYZOfficiel = GUICtrlCreateLabel("Activate XYZ", 245, 232, 65, 17)
$LaunchRaccourcisOfficiel = GUICtrlCreateCheckbox("Checkbox", 225, 250, 15, 15)
$LBLLaunchRaccourcisOfficiel = GUICtrlCreateLabel("Shortcuts", 245, 252, 65, 17)
...
$DebloPersobutton = GUICtrlCreateButton("Click to unstuck your character", 30, 25, 230, 70, $WS_GROUP)
...
$Stopchutebutton = GUICtrlCreateButton("Click to stop falling", 30, 25, 230, 70, $WS_GROUP)
...
$PreviewList = GUICtrlCreateListView("number|Nom|Map|X|Y|Z|Commentaire",0,50,660,450)
...
$listTeleportGO = GUICtrlCreateButton("Teleport",320,510,180,40)
$WEHcheckbox = GUICtrlCreateCheckbox("Checkbox", 430, 555, 15, 15)
$LVLlisteweh = GUICtrlCreateLabel("WEH List", 370, 557, 54, 17)
$AddTPGRP = GUICtrlCreateGroup("Add a TP", 670, 55, 120, 105)
$LBLNomTP = GUICtrlCreateLabel("TP's name", 690, 75, 90, 17)
$AddTPNameInput = GUICtrlCreateInput("", 675, 90, 110, 20)
$AddTP = GUICtrlCreateButton("Add TP",680,115,100,35)
$DelTPGRP = GUICtrlCreateGroup("Delete a TP", 670, 180, 120, 105)
$LBLTPNumber = GUICtrlCreateLabel("TP's number", 705, 200, 60, 17)
$DelTPInput = GUICtrlCreateInput("", 705, 215, 50, 20)
$DelTP = GUICtrlCreateButton("Delete TP",680,240,100,35)
...
$LBLMapActuelle = GUICtrlCreateLabel("Current Map", 701, 345, 90, 17)
...
$LBLSCWallclimbOf = GUICtrlCreateLabel("wallclimb", 10, 33, 75, 17)
$SettingInputSupersaut = GUICtrlCreateInput("", 110, 60, 80, 20, $ES_READONLY)
$LBLSCSupersautOf = GUICtrlCreateLabel("Super-jump", 10, 63, 54, 17)
...
$PriveSCsettingsGUI = GUICreate("Shortcuts(Priv)", 545, 620, -1, -1, -1)
GUISetBkColor(0xefefef)
;;; FONCTIONS
$PriveSCsettingsGUIGRPFonction = GUICtrlCreateGroup("Functions", 15, 10, 170, 320)
$PriveSettingInputFlymod = GUICtrlCreateInput("", 125, 25, 50, 20, $ES_READONLY)
$LBLSCFlymod = GUICtrlCreateLabel("FlyMod", 25, 28, 54, 17)
$PriveSettingInputSpeedglobale = GUICtrlCreateInput("", 125, 50, 50, 20, $ES_READONLY)
$LBLSCSpeedglobale = GUICtrlCreateLabel("Overall speed", 25, 53, 85, 17)
$PriveSettingInputSpeed = GUICtrlCreateInput("", 125, 75, 50, 20, $ES_READONLY)
$LBLSCSpeed = GUICtrlCreateLabel("Speed", 25, 78, 54, 17)
$PriveSettingInputWallclimb = GUICtrlCreateInput("", 125, 100, 50, 20, $ES_READONLY)
$LBLSCWallclimb = GUICtrlCreateLabel("wallclimb", 25, 103, 75, 17)
$PriveSettingInputSupersaut = GUICtrlCreateInput("", 125, 125, 50, 20, $ES_READONLY)
$LBLSCSupersaut = GUICtrlCreateLabel("Super-jump", 25, 128, 54, 17)
$PriveSettingInputDebloperso = GUICtrlCreateInput("", 125, 150, 50, 20, $ES_READONLY)
$LBLSCDebloperso = GUICtrlCreateLabel("unstuck", 25, 153, 100, 17)
...
$LBLSCGocorps = GUICtrlCreateLabel("Go to corpse", 25, 203, 100, 17)
$PriveSettingInputStopfall = GUICtrlCreateInput("", 125, 225, 50, 20, $ES_READONLY)
$LBLSCStopchute = GUICtrlCreateLabel("Stop falling", 25, 228, 100, 17)
$PriveSettingInputTpcibledos = GUICtrlCreateInput("", 125, 250, 50, 20, $ES_READONLY)
$LBLSCTPcibledos = GUICtrlCreateLabel("TP Target(back)", 25, 253, 100, 17)
$PriveSettingInputTpcibleundermap = GUICtrlCreateInput("", 125, 275, 50, 20, $ES_READONLY)
$LBLSCTPcibleundermap = GUICtrlCreateLabel("TP Tar(under map)", 25, 278, 100, 17)
$PriveSettingInputFreezeZ = GUICtrlCreateInput("", 125, 300, 50, 20, $ES_READONLY)
$LBLSCFreezeZ = GUICtrlCreateLabel("Freeze Z", 25, 303, 100, 17)
$PriveSCsettingsGUIGRPSpeed = GUICtrlCreateGroup("Speed", 15, 335, 170, 270)
$PriveSettingInputSpeedN = GUICtrlCreateInput("", 125, 350, 50, 20, $ES_READONLY)
$LBLSCSpeedN = GUICtrlCreateLabel("Default speed", 25, 353, 100, 17)
$PriveSettingInputSpeed100 = GUICtrlCreateInput("", 125, 375, 50, 20, $ES_READONLY)
$LBLSCSpeed100 = GUICtrlCreateLabel("speed 100%", 25, 378, 100, 17)
...
$LBLSCSpeedP = GUICtrlCreateLabel("Speed +", 25, 428, 60, 17)
$PriveSettingInputSpeedM = GUICtrlCreateInput("", 125, 450, 50, 20, $ES_READONLY)
$LBLSCSpeedM = GUICtrlCreateLabel("Speed -", 25, 453, 60, 17)
...
$LBLSCSpeedFlyN = GUICtrlCreateLabel("Default fly speed", 25, 478, 100, 17)
$PriveSettingInputSpeedFly280 = GUICtrlCreateInput("", 125, 500, 50, 20, $ES_READONLY)
$LBLSCSpeedFly280 = GUICtrlCreateLabel("Fly speed 280%", 25, 503, 100, 17)
$PriveSettingInputSpeedFlycustom = GUICtrlCreateInput("", 125, 525, 50, 20, $ES_READONLY)
$LBLSCSpeedFlycustom = GUICtrlCreateLabel("Fly speed =", 25, 528, 60, 17)
...
$LBLSCTimeSpeedP = GUICtrlCreateLabel("Time Speed +", 200, 473, 90, 17)
$PriveSettingInputTimeSpeedM = GUICtrlCreateInput("", 295, 495, 50, 20, $ES_READONLY)
$LBLSCTimeSpeedM = GUICtrlCreateLabel("Time Speed -", 200, 498, 90, 17)
...
$LBLSCTailleP = GUICtrlCreateLabel("Scale +", 355, 423, 90, 17)
$PriveSettingInputTailleM = GUICtrlCreateInput("", 450, 445, 50, 20, $ES_READONLY)
$LBLSCTailleM = GUICtrlCreateLabel("Scale -", 355, 448, 90, 17)
...
EndIf
;;; PVP
$PriveSCsettingsGUIGRPPvP = GUICtrlCreateGroup("Pvp - teleportation's shortcuts", 192, 10, 335, 390)
;;; GOULET
$PriveSCsettingsGUIGRPGoulet = GUICtrlCreateGroup("Warsong gulch", 197, 25, 160, 220)
$PriveSettingInputGouletFlagA2 = GUICtrlCreateInput("", 300, 40, 50, 20, $ES_READONLY)
$LBLSCGouletFlagA2 = GUICtrlCreateLabel("Alliance Flag", 205, 43, 90, 17)
...
$LBLSCGouletFlagH2 = GUICtrlCreateLabel("Horde Flag", 205, 143, 90, 17)
...
$LBLSCArathiEcurie = GUICtrlCreateLabel("Stable", 285, 268, 90, 17)
$PriveSettingInputArathiFerme = GUICtrlCreateInput("", 380, 290, 50, 20, $ES_READONLY)
$LBLSCArathiFerme = GUICtrlCreateLabel("Farm", 285, 293, 90, 17)
...
$LBLSCArathiScierie = GUICtrlCreateLabel("Sawmill", 285, 368, 90, 17)
;;; OEIL
$PriveSCsettingsGUIGRPOeil = GUICtrlCreateGroup("Eye of the storm", 362, 25, 160, 145)
$PriveSettingInputOeilDrapeau = GUICtrlCreateInput("", 465, 40, 50, 20, $ES_READONLY)
$LBLSCOeilDrapeau = GUICtrlCreateLabel("Flag", 370, 43, 90, 17)
$PriveSettingInputOeilTourMages = GUICtrlCreateInput("", 465, 65, 50, 20, $ES_READONLY)
$LBLSCOeilTourMages = GUICtrlCreateLabel("Mage Tower", 370, 68, 90, 17)
$PriveSettingInputOeilRuinesDraenei = GUICtrlCreateInput("", 465, 90, 50, 20, $ES_READONLY)
$LBLSCOeilRuinesDraenei = GUICtrlCreateLabel("Draenei Ruins", 370, 93, 90, 17)
...
$LBLSCOeilRuinesSaccageur = GUICtrlCreateLabel("Reaver Ruines", 370, 143, 90, 17)
;;; ALTERAC
...
$LBLSCAlteracA2 = GUICtrlCreateLabel("Alliance side", 370, 193, 90, 17)
$PriveSettingInputAlteracH2 = GUICtrlCreateInput("", 465, 215, 50, 20, $ES_READONLY)
$LBLSCAlteracH2 = GUICtrlCreateLabel("Horde side", 370, 218, 90, 17)
...
refreshSCtext("ScaleP", $PriveSettingInputTailleP)
refreshSCtext("ScaleM", $PriveSettingInputTailleM)
	...
	;;;;;;;;;;;;;;;;;;;;; FERMETURE DES FENETRES
		Case $GUI_EVENT_CLOSE
			...
			ElseIf WinActive("Raccourcis Officiel") Then
				...
				EndIf
					GUISetState(@SW_HIDE, $SCsettingsGUI)
			ElseIf WinActive("The RPwow Hack") Then
...
func globalf()
$WowProcessListViewItemCount = ProcessList("RPWoW.exe")
...
$PlayerBase = _MemoryRead($PB2+$PbPointer2,$WowProcess,"Ptr")
$PlayerBase2 = _MemoryRead($PlayerBase+8,$WowProcess,"Ptr")
Global $build_version = _MemoryRead($BuildAddr,$WowProcess,"char[31]")
GUICtrlSetData($State, $build_version)
;If $build_version =$Build Then
;If IniRead($Setting,"Langue","Langue","Erreur") = 0 Then
...
func Reset()
_MemoryClose ($WowPid)
Global $WowPid = ProcessExists("RPWoW.exe")
Global $WowProcess = _MEMORYOPEN ($WowPid)
$PB1 = _MemoryRead($StaticPlayer,$WowProcess,"Ptr")
$PB2 = _MemoryRead($PB1+$PbPointer1,$WowProcess,"Ptr")
$PlayerBase = _MemoryRead($PB2+$PbPointer2,$WowProcess,"Ptr")
